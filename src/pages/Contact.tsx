          ...
          <div className="mx-auto max-w-7xl">
            <div className="text-center">
              <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
                <span className="block text-green-600">Get in Touch</span>
                <span className="block text-orange-500">
                  We'd Love to Hear from You
                </span>
              </h1>
              <p className="mx-auto mt-3 max-w-md text-base text-gray-500 sm:text-lg md:mt-5 md:max-w-3xl md:text-xl">
                Questions, comments, or special requests? We're here to help!
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-green-50 p-6 rounded-lg text-center">
                ...
                <p className="text-gray-600">9586901881</p>
              ...
              <div className="bg-green-50 p-6 rounded-lg text-center">
                ...
                <p className="text-gray-600">info@pokargreens.com</p>
          ...
          <div className="mx-auto max-w-3xl bg-white rounded-lg shadow-lg overflow-hidden">
            <div className="md:flex">
              <div className="md:w-1/3 bg-green-600 text-white p-8">
                ...
                <p className="mb-6">
                  Have questions about our products or delivery? Want to suggest
                  a new produce item? We'd love to hear from you!
                </p>
                <div className="mt-8">
            ...
            <div className="rounded-lg overflow-hidden shadow-lg h-64 bg-gray-200">
              <div className="h-full w-full flex items-center justify-center bg-gray-200">
                <p className="text-gray-500">
                  Map location placeholder - 123 Fresh Street, Greenville, CA
                  94107
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="bg-white p-6 rounded-lg shadow">
                ...
                <p className="text-gray-600">
                  We currently deliver to the greater Greenville area, including
                  surrounding suburbs within a 25-mile radius of our facility.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow">
                ...
                <p className="text-gray-600">
                  We offer delivery Monday through Saturday, with specific
                  delivery windows available during checkout.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow">
                ...
                <p className="text-gray-600">
                  You can modify or cancel your order up to 24 hours before your
                  scheduled delivery time through your account dashboard.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow">
                ...
                <p className="text-gray-600">
                  Yes! All our fruits and vegetables are 100% certified organic
                  and sourced directly from local farms.
                </p>
              </div>
            </div>
          </div>
        ...
        {/* <div className="bg-green-600 py-12 px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-xl text-center">
            ...
            <p className="text-green-100 mb-6">
              Subscribe to our newsletter for seasonal produce updates, recipes,
            ...
            <form className="mt-6 flex max-w-md mx-auto">
              <input
                ...
                className="w-full rounded-l-lg border-white px-5 py-3 text-base text-gray-900 focus:outline-none"
              />
              <button
                type="submit"
                className="rounded-r-lg bg-orange-500 px-5 py-3 text-base font-medium text-white hover:bg-orange-600 focus:outline-none"
              >
                Subscribe
              </button>
            </form>
